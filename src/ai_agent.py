...
class AIAgent:
    def __init__(self, config: Config) -> None:
        ...
        self.message_history.add_message(SystemMessage(content=config.system_prompt))
            ...
            match msg:
                case AIMessage(tool_calls=tool_calls) if tool_calls:
                    for tool_call in tool_calls:
                        ...
                        msg = f"[yellow]Calling {tool_name}({tool_args})[/yellow]"
    ...
    def print_response(self, response: AIMessage) -> None:
        ...
        if response.content:
            ...
            self.console.print(Panel(Markdown(content_str), border_style="green"))
    ...
    def get_system_messages(self) -> list[BaseMessage]:
        ...
        return filter_messages(self.message_history.messages, include_types="system")
